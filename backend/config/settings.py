...
# Use the Redis password as-is (already properly configured for Redis server)
import logging

logger = logging.getLogger(__name__)

logger.error(f"=== Redis Password Fixed ===")
logger.error(f"REDIS_PASSWORD used: {REDIS_PASSWORD}")
