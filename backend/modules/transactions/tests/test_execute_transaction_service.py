...
class TestCase:
    ...
    def test_sell__success__transaction_gets_created(self):
        ...
        self._run_simple_test_case(is_buy=False)
    ...
    def test_sell__enough_assets__balance_is_updated(self):
        ...
        self._run_simple_test_case(balance=initial_balance, is_buy=False)
    ...
    def test_sell__not_enough_assets__exception_gets_raised(self):
        ...
        with pytest.raises(ValueError):
            self._run_simple_test_case(volume=Decimal("2"), is_buy=False)
