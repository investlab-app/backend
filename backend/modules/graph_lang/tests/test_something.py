import pytest
from modules.graph_lang.framework.parser import NodeData, EdgeData, GraphData
...
class TestValidator:
    ...
    def test__invalid_node_type__returns_invalid_type_error(self):
        _, errors = self.run(GraphData(nodes=[
            NodeData(id="0", type=None),
    ...
    #             EdgeData(id_a="2", handle_a="mismatch_val", id_b="1", handle_b="number"),
    #         ],
    #     )
    #     _, errors = self.run(data)
    ...
    #         ],
    #         edges=[
    #             EdgeData(id_a="0", handle_a="number", id_b="0", handle_b="number"),
    #             EdgeData(id_a="1", handle_a="number", id_b="1", handle_b="number"),
    #         ],
    #     )
    #     _, errors = self.run(data)
    ...
    # @pytest.mark.parametrize("no_triggers, raises_error", [
    #     (0, True),
    #     (1, False),
    #     (2, True),
    # ])
    ...
    #     data = GraphData(
    #         nodes=[
    #             NodeData(id=str(i), type=TriggerNode)
    #             for i in range(no_triggers)
    #         ],
    #     )
    #     _, errors = self.run(data)
    ...
    #         assert DanglingNodeInGraph() in errors
    #     else:
    #         assert DanglingNodeInGraph() not in errors
    ...
    #             NodeData(id='2', type=NumberInputChangeSourceNode, fields={'inVal': '3'}),
    #             NodeData(id='3', type=NumberOutputNode)
    #         ],
    #         edges = [
    #             EdgeData(id_a='1', handle_a='inVal', id_b='3', handle_b='number')
    #         ]
    #     )
