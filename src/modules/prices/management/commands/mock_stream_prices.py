...
from modules.prices.services import PriceService
...
class PriceStreamMock:
    ...
    def __init__(self, price_service : PriceService | None = None,
        ...
        self.initial_prices = price_service.get_latest_daily_bars_from_last_n_days(2)
    ...
    def _generate_prices(self):
        ...
        for ticker, price_bar in self.initial_prices.items():
            new_data[ticker] = {
                ...
                'aggregate_vwap': self._randomize_value(price_bar.volume_weighted_average_price),
