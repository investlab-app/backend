...
class TransactionStatsService:
    ...
    def compute_stats_in_period(self, start: datetime, end: datetime) -> dict[str, Any]:
        ...
        realized_gain = Decimal(0)
        total_buy_cost = sum(i.volume * i.price for i in initial_lots)
        sell_details = []
        ...
        return {
            ...
            "details": {
                "sells": sell_details,
                "initial_lots": [
                    {"volume": i.volume, "price": i.price} for i in initial_lots
                ],
                "ending_lots": [
                    {"volume": i.volume, "price": i.price} for i in buy_lots
                ],
            },
        }
